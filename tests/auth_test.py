...
class TestLoadCredentials(unittest.TestCase):
    ...
    def test_env_with_no_credentials(self, mock_load_dotenv: mock.MagicMock, mock_getenv: mock.MagicMock) -> None:
    ...
    def test_env_exist_with_valid_credentials(self, mock_load_dotenv: mock.MagicMock, mock_getenv: mock.MagicMock) -> None:
